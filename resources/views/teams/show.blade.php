...
<div class="container justify-content-center">
    <div class="row">
        <div class="my-3 col-lg-4 col-md-12"  {{-- style="max-width: 720px;" --}}>
          <div class="card">
              <div class="row g-0">
                <div class="col-md-4">
                  <img src="{{asset("storage/". $squadra->logo)}}" class="img-fluid rounded-start p-2" alt="stemma_{{$squadra->nome}}">
                </div>
                <div class="col-md-8">
                  <div class="card-body">
        ...
        <div class="accordion my-3 col-lg-8 col-md-12" id="accordionExample" >
